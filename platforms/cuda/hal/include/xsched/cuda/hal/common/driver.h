...
#include "xsched/cuda/hal/common/cupti.h"
...
/// This file is auto-generated by command "python3 tools/autogen/gen.py --source ./platforms/cuda/hal/include/xsched/cuda/hal/common/cupti.h --platform cuda --prefix cupti --lib /usr/lib/x86_64-linux-gnu/libcupti.so -I /usr/lib/gcc/x86_64-linux-gnu/13/include -I ./platforms/cuda/hal/include"
class PTI
{
private:
#if defined(_WIN32)
    DEFINE_GET_SYMBOL_FUNC(GetSymbol, XSCHED_CUPTI_LIB_ENV_NAME,
                           std::vector<std::string>({"cupti64_129.dll"}), // FIXME: add more versions
                           std::vector<std::string>({}));
#elif defined(__linux__)
    DEFINE_GET_SYMBOL_FUNC(GetSymbol, XSCHED_CUPTI_LIB_ENV_NAME,
                           std::vector<std::string>({"libcupti.so"}),
                           std::vector<std::string>({}));
#endif
...
public:
    ...
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetResultString"), CUptiResult, GetResultString, CUptiResult, result, const char **, str);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetVersion"), CUptiResult, GetVersion, uint32_t *, version);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiSupportedDomains"), CUptiResult, SupportedDomains, size_t *, domainCount, CUpti_DomainTable *, domainTable);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiSubscribe"), CUptiResult, Subscribe, CUpti_SubscriberHandle *, subscriber, CUpti_CallbackFunc, callback, void *, userdata);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiUnsubscribe"), CUptiResult, Unsubscribe, CUpti_SubscriberHandle, subscriber);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetCallbackState"), CUptiResult, GetCallbackState, uint32_t *, enable, CUpti_SubscriberHandle, subscriber, CUpti_CallbackDomain, domain, CUpti_CallbackId, cbid);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEnableCallback"), CUptiResult, EnableCallback, uint32_t, enable, CUpti_SubscriberHandle, subscriber, CUpti_CallbackDomain, domain, CUpti_CallbackId, cbid);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEnableDomain"), CUptiResult, EnableDomain, uint32_t, enable, CUpti_SubscriberHandle, subscriber, CUpti_CallbackDomain, domain);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEnableAllDomains"), CUptiResult, EnableAllDomains, uint32_t, enable, CUpti_SubscriberHandle, subscriber);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetCallbackName"), CUptiResult, GetCallbackName, CUpti_CallbackDomain, domain, uint32_t, cbid, const char **, name);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiSetEventCollectionMode"), CUptiResult, SetEventCollectionMode, CUcontext, context, CUpti_EventCollectionMode, mode);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceGetAttribute"), CUptiResult, DeviceGetAttribute, CUdevice, device, CUpti_DeviceAttribute, attrib, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceGetNumEventDomains"), CUptiResult, DeviceGetNumEventDomains, CUdevice, device, uint32_t *, numDomains);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceEnumEventDomains"), CUptiResult, DeviceEnumEventDomains, CUdevice, device, size_t *, arraySizeBytes, CUpti_EventDomainID *, domainArray);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceGetEventDomainAttribute"), CUptiResult, DeviceGetEventDomainAttribute, CUdevice, device, CUpti_EventDomainID, eventDomain, CUpti_EventDomainAttribute, attrib, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetNumEventDomains"), CUptiResult, GetNumEventDomains, uint32_t *, numDomains);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEnumEventDomains"), CUptiResult, EnumEventDomains, size_t *, arraySizeBytes, CUpti_EventDomainID *, domainArray);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventDomainGetAttribute"), CUptiResult, EventDomainGetAttribute, CUpti_EventDomainID, eventDomain, CUpti_EventDomainAttribute, attrib, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventDomainGetNumEvents"), CUptiResult, EventDomainGetNumEvents, CUpti_EventDomainID, eventDomain, uint32_t *, numEvents);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventDomainEnumEvents"), CUptiResult, EventDomainEnumEvents, CUpti_EventDomainID, eventDomain, size_t *, arraySizeBytes, CUpti_EventID *, eventArray);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGetAttribute"), CUptiResult, EventGetAttribute, CUpti_EventID, event, CUpti_EventAttribute, attrib, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGetIdFromName"), CUptiResult, EventGetIdFromName, CUdevice, device, const char *, eventName, CUpti_EventID *, event);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupCreate"), CUptiResult, EventGroupCreate, CUcontext, context, CUpti_EventGroup *, eventGroup, uint32_t, flags);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupDestroy"), CUptiResult, EventGroupDestroy, CUpti_EventGroup, eventGroup);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupGetAttribute"), CUptiResult, EventGroupGetAttribute, CUpti_EventGroup, eventGroup, CUpti_EventGroupAttribute, attrib, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupSetAttribute"), CUptiResult, EventGroupSetAttribute, CUpti_EventGroup, eventGroup, CUpti_EventGroupAttribute, attrib, size_t, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupAddEvent"), CUptiResult, EventGroupAddEvent, CUpti_EventGroup, eventGroup, CUpti_EventID, event);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupRemoveEvent"), CUptiResult, EventGroupRemoveEvent, CUpti_EventGroup, eventGroup, CUpti_EventID, event);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupRemoveAllEvents"), CUptiResult, EventGroupRemoveAllEvents, CUpti_EventGroup, eventGroup);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupResetAllEvents"), CUptiResult, EventGroupResetAllEvents, CUpti_EventGroup, eventGroup);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupEnable"), CUptiResult, EventGroupEnable, CUpti_EventGroup, eventGroup);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupDisable"), CUptiResult, EventGroupDisable, CUpti_EventGroup, eventGroup);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupReadEvent"), CUptiResult, EventGroupReadEvent, CUpti_EventGroup, eventGroup, CUpti_ReadEventFlags, flags, CUpti_EventID, event, size_t *, eventValueBufferSizeBytes, uint64_t *, eventValueBuffer);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupReadAllEvents"), CUptiResult, EventGroupReadAllEvents, CUpti_EventGroup, eventGroup, CUpti_ReadEventFlags, flags, size_t *, eventValueBufferSizeBytes, uint64_t *, eventValueBuffer, size_t *, eventIdArraySizeBytes, CUpti_EventID *, eventIdArray, size_t *, numEventIdsRead);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupSetsCreate"), CUptiResult, EventGroupSetsCreate, CUcontext, context, size_t, eventIdArraySizeBytes, CUpti_EventID *, eventIdArray, CUpti_EventGroupSets **, eventGroupPasses);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupSetsDestroy"), CUptiResult, EventGroupSetsDestroy, CUpti_EventGroupSets *, eventGroupSets);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupSetEnable"), CUptiResult, EventGroupSetEnable, CUpti_EventGroupSet *, eventGroupSet);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEventGroupSetDisable"), CUptiResult, EventGroupSetDisable, CUpti_EventGroupSet *, eventGroupSet);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEnableKernelReplayMode"), CUptiResult, EnableKernelReplayMode, CUcontext, context);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDisableKernelReplayMode"), CUptiResult, DisableKernelReplayMode, CUcontext, context);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiKernelReplaySubscribeUpdate"), CUptiResult, KernelReplaySubscribeUpdate, CUpti_KernelReplayUpdateFunc, updateFunc, void *, customData);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetNumMetrics"), CUptiResult, GetNumMetrics, uint32_t *, numMetrics);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiEnumMetrics"), CUptiResult, EnumMetrics, size_t *, arraySizeBytes, CUpti_MetricID *, metricArray);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceGetNumMetrics"), CUptiResult, DeviceGetNumMetrics, CUdevice, device, uint32_t *, numMetrics);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceEnumMetrics"), CUptiResult, DeviceEnumMetrics, CUdevice, device, size_t *, arraySizeBytes, CUpti_MetricID *, metricArray);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricGetAttribute"), CUptiResult, MetricGetAttribute, CUpti_MetricID, metric, CUpti_MetricAttribute, attrib, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricGetIdFromName"), CUptiResult, MetricGetIdFromName, CUdevice, device, const char *, metricName, CUpti_MetricID *, metric);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricGetNumEvents"), CUptiResult, MetricGetNumEvents, CUpti_MetricID, metric, uint32_t *, numEvents);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricEnumEvents"), CUptiResult, MetricEnumEvents, CUpti_MetricID, metric, size_t *, eventIdArraySizeBytes, CUpti_EventID *, eventIdArray);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricGetNumProperties"), CUptiResult, MetricGetNumProperties, CUpti_MetricID, metric, uint32_t *, numProp);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricEnumProperties"), CUptiResult, MetricEnumProperties, CUpti_MetricID, metric, size_t *, propIdArraySizeBytes, CUpti_MetricPropertyID *, propIdArray);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricGetRequiredEventGroupSets"), CUptiResult, MetricGetRequiredEventGroupSets, CUcontext, context, CUpti_MetricID, metric, CUpti_EventGroupSets **, eventGroupSets);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricCreateEventGroupSets"), CUptiResult, MetricCreateEventGroupSets, CUcontext, context, size_t, metricIdArraySizeBytes, CUpti_MetricID *, metricIdArray, CUpti_EventGroupSets **, eventGroupPasses);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricGetValue"), CUptiResult, MetricGetValue, CUdevice, device, CUpti_MetricID, metric, size_t, eventIdArraySizeBytes, CUpti_EventID *, eventIdArray, size_t, eventValueArraySizeBytes, uint64_t *, eventValueArray, uint64_t, timeDuration, CUpti_MetricValue *, metricValue);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiMetricGetValue2"), CUptiResult, MetricGetValue2, CUpti_MetricID, metric, size_t, eventIdArraySizeBytes, CUpti_EventID *, eventIdArray, size_t, eventValueArraySizeBytes, uint64_t *, eventValueArray, size_t, propIdArraySizeBytes, CUpti_MetricPropertyID *, propIdArray, size_t, propValueArraySizeBytes, uint64_t *, propValueArray, CUpti_MetricValue *, metricValue);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetTimestamp"), CUptiResult, GetTimestamp, uint64_t *, timestamp);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetContextId"), CUptiResult, GetContextId, CUcontext, context, uint32_t *, contextId);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetStreamId"), CUptiResult, GetStreamId, CUcontext, context, CUstream, stream, uint32_t *, streamId);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetStreamIdEx"), CUptiResult, GetStreamIdEx, CUcontext, context, CUstream, stream, uint8_t, perThreadStream, uint32_t *, streamId);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetDeviceId"), CUptiResult, GetDeviceId, CUcontext, context, uint32_t *, deviceId);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetGraphNodeId"), CUptiResult, GetGraphNodeId, CUgraphNode, node, uint64_t *, nodeId);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetGraphId"), CUptiResult, GetGraphId, CUgraph, graph, uint32_t *, pId);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityEnable"), CUptiResult, ActivityEnable, CUpti_ActivityKind, kind);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityEnableAndDump"), CUptiResult, ActivityEnableAndDump, CUpti_ActivityKind, kind);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityDisable"), CUptiResult, ActivityDisable, CUpti_ActivityKind, kind);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityEnableContext"), CUptiResult, ActivityEnableContext, CUcontext, context, CUpti_ActivityKind, kind);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityDisableContext"), CUptiResult, ActivityDisableContext, CUcontext, context, CUpti_ActivityKind, kind);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityGetNumDroppedRecords"), CUptiResult, ActivityGetNumDroppedRecords, CUcontext, context, uint32_t, streamId, size_t *, dropped);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityGetNextRecord"), CUptiResult, ActivityGetNextRecord, uint8_t *, buffer, size_t, validBufferSizeBytes, CUpti_Activity **, record);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityRegisterCallbacks"), CUptiResult, ActivityRegisterCallbacks, CUpti_BuffersCallbackRequestFunc, funcBufferRequested, CUpti_BuffersCallbackCompleteFunc, funcBufferCompleted);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityFlush"), CUptiResult, ActivityFlush, CUcontext, context, uint32_t, streamId, uint32_t, flag);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityFlushAll"), CUptiResult, ActivityFlushAll, uint32_t, flag);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityGetAttribute"), CUptiResult, ActivityGetAttribute, CUpti_ActivityAttribute, attr, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivitySetAttribute"), CUptiResult, ActivitySetAttribute, CUpti_ActivityAttribute, attr, size_t *, valueSize, void *, value);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityConfigureUnifiedMemoryCounter"), CUptiResult, ActivityConfigureUnifiedMemoryCounter, CUpti_ActivityUnifiedMemoryCounterConfig *, config, uint32_t, count);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetAutoBoostState"), CUptiResult, GetAutoBoostState, CUcontext, context, CUpti_ActivityAutoBoostState *, state);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityConfigurePCSampling"), CUptiResult, ActivityConfigurePCSampling, CUcontext, ctx, CUpti_ActivityPCSamplingConfig *, config);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetLastError"), CUptiResult, GetLastError);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiSetThreadIdType"), CUptiResult, SetThreadIdType, CUpti_ActivityThreadIdType, type);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiGetThreadIdType"), CUptiResult, GetThreadIdType, CUpti_ActivityThreadIdType *, type);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiComputeCapabilitySupported"), CUptiResult, ComputeCapabilitySupported, int, major, int, minor, int *, support);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceSupported"), CUptiResult, DeviceSupported, CUdevice, dev, int *, support);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiDeviceVirtualizationMode"), CUptiResult, DeviceVirtualizationMode, CUdevice, dev, CUpti_DeviceVirtualizationMode *, mode);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiFinalize"), CUptiResult, Finalize);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityPushExternalCorrelationId"), CUptiResult, ActivityPushExternalCorrelationId, CUpti_ExternalCorrelationKind, kind, uint64_t, id);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityPopExternalCorrelationId"), CUptiResult, ActivityPopExternalCorrelationId, CUpti_ExternalCorrelationKind, kind, uint64_t *, lastId);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityEnableLatencyTimestamps"), CUptiResult, ActivityEnableLatencyTimestamps, uint8_t, enable);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityFlushPeriod"), CUptiResult, ActivityFlushPeriod, uint32_t, time);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityEnableLaunchAttributes"), CUptiResult, ActivityEnableLaunchAttributes, uint8_t, enable);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuptiActivityRegisterTimestampCallback"), CUptiResult, ActivityRegisterTimestampCallback, CUpti_TimestampCallbackFunc, funcTimestamp);
